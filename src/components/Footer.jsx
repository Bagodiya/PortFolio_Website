    ...
    >
      <div className="mx-auto px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between">
          ...
          >
            <a
              href="SofiyaBagodiya_Resume.pdf"
              download
              target="_blank"
          ...
          <div className="flex gap-4 mt-4 sm:mt-0">
            {[
              "https://github.com/sofiya230", 
              "https://www.linkedin.com/in/sofiyabagodiya",
            ].map((url, index) => (
              <motion.div
                key={index}
        ...
        <div className="text-center text-xs text-neutral-400 mt-6">
          © {new Date().getFullYear()} Sofiya Bagodiya. All rights reserved.
        </div>
      </div>
    </motion.footer>
  );
